...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        nA.next.next = new Node(0);
        nA.next.next.value = 3;

        nA.next.next.next = new Node(0);
        nA.next.next.next.value = 4;

        nA.next.next.next.next = new Node(0);
        ...
        nB.next.next = new Node(0);
        nB.next.next.value = 5;

        nB.next.next.next = new Node(0);
        nB.next.next.next.value = 6;

        nB.next.next.next.next = new Node(0);
